...
type SnapshotSchema_Schema int32

const (
	SnapshotSchema_SMT    SnapshotSchema_Schema = 0
	SnapshotSchema_VERKLE SnapshotSchema_Schema = 1
)

var SnapshotSchema_Schema_name = map[int32]string{
	0: "SMT",
	1: "VERKLE",
}

var SnapshotSchema_Schema_value = map[string]int32{
	"SMT":    0,
	"VERKLE": 1,
}

func (x SnapshotSchema_Schema) String() string {
	return proto.EnumName(SnapshotSchema_Schema_name, int32(x))
}

func (SnapshotSchema_Schema) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dd7a3c9b0a19e1ee, []int{8, 0}
}
...
type SnapshotSchema struct {
	...
	Schemas []SnapshotSchema_Schema `protobuf:"varint,2,rep,packed,name=schemas,proto3,enum=cosmos.base.snapshots.v1beta1.SnapshotSchema_Schema" json:"schemas,omitempty"`
}
...
func (m *SnapshotSchema) GetSchemas() []SnapshotSchema_Schema {
	if m != nil {
		return m.Schemas
	}
	return nil
...
func init() {
	proto.RegisterEnum("cosmos.base.snapshots.v1beta1.SnapshotSchema_Schema", SnapshotSchema_Schema_name, SnapshotSchema_Schema_value)
...
var fileDescriptor_dd7a3c9b0a19e1ee = []byte{
	...
	,
}
...
func (m *SnapshotSchema) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Schemas) > 0 {
		dAtA9 := make([]byte, len(m.Schemas)*10)
		var j8 int
		for _, num := range m.Schemas {
			for num >= 1<<7 {
		...
		i = encodeVarintSnapshot(dAtA, i, uint64(j8))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Keys) > 0 {
		...
		case 2:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= SnapshotSchema_Schema(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.Schemas = append(m.Schemas, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.Schemas) == 0 {
					m.Schemas = make([]SnapshotSchema_Schema, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v SnapshotSchema_Schema
					for shift := uint(0); ; shift += 7 {
